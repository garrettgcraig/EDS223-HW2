...
#| fig-width: 10
#| fig-height: 8
#| fig-cap: "Historical redlining in Los Angeles County showing HOLC grades from the 1930s. Grade A (green) represents 'best' neighborhoods, Grade B (blue) 'still desirable', Grade C (yellow) 'definitely declining', and Grade D (red) 'hazardous'."
...
```{r holc-summary}
#| tbl-cap: "Distribution of census block groups across HOLC grades in Los Angeles County. The majority of block groups were not assigned historical HOLC grades."
...
#| fig-cap: "Mean environmental and socioeconomic conditions by HOLC grade. Grade D (redlined) neighborhoods show higher percentages of low-income residents, higher PM2.5 exposure, and lower life expectancy compared to Grade A neighborhoods."
...
```{r bird-observations}
#| fig-cap: "Distribution of bird observations across HOLC grades in Los Angeles County (2021-2023). Grade C neighborhoods have the highest percentage of observations, while Grade D (redlined) neighborhoods have the lowest."
